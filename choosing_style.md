...
В общем случае, можно предложить следующее правило: использование 1TBS стиля возможно, когда
  - заголовок утверждения, предшествующий `{` занимает одну строку в левой части страницы текста и её окончание не сливается с окончанием первой строки обрамляемого кода, и этот код не содержит более трех строк.
