...
Как показали результаты исследований, использование любого другого разделителя между словами требует больших усилий при чтении. Пробелы также участвуют в формировании визуальной структуры программы для разделения различных элементов ее логической структуры. Поэтому, например, имеет смысл разделять пробелом имя функции и список ее параметров/аргументов, например, в случае, если их совокупная длина превышает размер области распознавания.
