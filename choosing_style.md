...
_– Рудольф Арнхейм, Искусство и визуальное восприятие_
...
Удовлетворенность разработчиков очевидно определяется тем, насколько легко дается им сопровождение и развитие программы, и одним из решающих факторов, определяющих степень этой легкости,несомненно, является удобочитаемость текста программы.
...
_«Положение скобок не так важно»_ пишут Б. Керниган и Д. Ритчи в книге «Язык программирования Си». Но существование различных стилей расстановки фигурных скобок, и групп программистов, готовых отстаивать выбранный ими стиль, ставит под сомнение этот тезис классиков. Несоменно, в процессе разработки существуют и гораздо более важные вопросы, чем вопрос о расстановки скобок, но и этот вопрос, несмотря на свою сравнительную малость, все же заслуживает внимания, поскольку является одной из тех деталей, которые складываясь, как элементы мозаики, формируют окончательный вид программы и определяют, таким образом, ее удобочитаемость.

Проблема с правилами стиля, видимо, кроется в том, что они задают конкретные детали оформления кода, но не говорят о том, что же такое _удобочитаемость_, и как эти правила помогают ее достичь. Бездумное следование формальым правилам приводит к ситуации, в которой цель подменяется средствами. Непонятно, в чем светлое будущее, но главное – идти туда строем и в ногу. <!-- ???? -->

Очевидно, что общие механизмы восприятия и обработки человеком визуальной информации (и текстов, в частности) обладают определенными возможностями и имеют некоторые ограничения, которые в конечном счете определяют то, как много усилий потребуется для корректного и полного восприятия представленной информации. Следовательно __удобочитаемость__ текста определяется тем, насколько его визуальное представление учитывает специфические особенности этих общих механизмов восприятия, и является __объективной характеристикой__ качества визуального представления текста. Объективность удобочитаемости означает, что она не зависит от субъективных предпочтений и привычек отдельного индивидуума, а имеет всеобщий характер для всех людей в нормальном психическом и физическом состоянии.
...
В современной нейропсихологии существует представлении о двух различных зрительных системах: так называемом «амбьентном зрении» (от фр. ambiance = окружение) и о «фокальном зрении». В то время как первая, эволюционно более древняя, ответственна за динамическую пространственную локализацию, вторая занимается идентификацией объектов.
...
Объекты, представляющие собой источник нужных сведений, распределены далеко не равномерно. Обычно они локализованы в небольших участках поля зрения. При этом с помощью амбьентного зрения обнаруживается потенциально интересный объект или элемент объекта, а при помощи фокального зрения направленного на объект, эти сведения воспринимаются и анализируются более детально. Сталкиваясь с новой ситуацией или с новым объектом, мы, как правило, сначала смотрим «широким полем» и лишь затем концентрируем наше внимание на деталях.
...
Интересной особенностью нашего зрения является способность воспринимать группу объектов как единое целое. Так на изображениях ниже мы видим собаку, а не просто набор хаотических пятен.

![](dog.jpg)

А на изображении ниже мы ясно различаем квадрат и круг.

![](Arnheim_1.png)[^10]

Первыми это явление стали изучать гештальтпсихологи. Так они сформулировали основной закон зрительного восприятия, согласно которому _любая стимулирующая модель воспринимается таким образом, что результирующая структура будет, насколько это позволяют данные условия, наиболее простой_. Поэтому мы воспринимаем квадрат именно так, как он изображен слева на следующем рисунке, а не каким-то другим образом.[^10]

![](Arnheim_2.png)

Они также сформулировали 6 принципов перцептивной организации. В сответствии с этими принципами _объекты, которые_ 
...
На иллюстрациях ниже[^10] показаны примеры сходства по близости, размеру, цвету. 

<img src="Arnheim_38.png" height="170"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<img src="Arnheim_35.png" height="170"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<img src="Arnheim_37.png" height="170"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
Учет этих принципов оказывается важным в случае перцептивного поиска или восприятия, поскольку, если информация организована в соответсвии с этими приципами, решение поставленной задачи требует меньших усилий за счет того, что перцептивное поле подвергается группировке, и на образовавшиеся группы элементов последовательно выделяется всё меньшая доля общих ресурсов. Распределение ресурсов внутри каждой группы оказывается примерно равномерным.

Задачи зрительного поиска обычно затрудняются при добавлении иррелевантных объектов — дистракторов. Однако в случае, когда такие дистракторы образуют визуально компактные группы, позволяющие игнорировать их как целое, их добавление наоборот может значительно облегчить поиск.
...
Существуют данные, показывающие, что при разделении слов в текста на тайском языке (для людей, которые никогда прежде не читали такие тексты с разделением слов пробелами), чтение осуществлялось более эффективно.
...
Говоря о визуальном представлении программы в целом, мы должны помнить, что целое наш глаз воспринимает амбьентным зрением, обладающим малой остротой и цветовосприятием. (Отсюда следует, для оценки визуальной структуры программы стоит выключить подсветку синтаксиса и попытаться охватить текст слегка расфокусированным взглядом.)
...
Во время создания программы мы располагаем различные элементы ее текста определенным образом – выравнивая их, располагая ближе или дальше относительно друг друга, – тем самым формируя из них графические объекты: области изображения, воспринимаемые как единое целое. Наша задача при этом заключается в том, чтобы эти объекты соотносились с элементами логической структуры программы.
...
Как упоминалось выше, существует некоторая ассиметрия в том, как человек воспринимает левую и правую части визуальной сцены. Эта ассиметрия еще более естественным образом пристутствует в восприятии текста программы: текст жестко привязан к левому краю, где отступы задают уровень иерархии в логической структуре программы. Правый же край свободен и не имеет жесткого ограничения. Чтение слева направо и сверху вниз определяет то, что начало чего-либо, то есть, то место где появляется что-то новое, должно находиться сверху и слева.

Отсутствие жесткого ограничения справа, тем не менее, не озачает, что ограничения нет. Многовековой опыт книгопечатания и десятилетия опыта, наработанные [веб-дизайнерами](http://webtypography.net/2.1.2), сходятся к тому, что оптимальная длина строки, обеспечивающей комфортное чтение составляет приблизительно 45-75 символов, независимо ни от размера шрифта, ни от наличия дополнительного пространства, позволяющего разместить более длинную строку. Насмотря на структурные отличия текста программы, трудно вообразить, что эти отличия настолько сильны, что могут сделать длинные строки, трудные для чтения обычных текстов, легкими в случае, когда мы читаем программу. Также как и при чтении прозы, длинные строки затрудняют переход от конца текущей строки к началу следующей. Но что еще хуже, длинные строки скрывают стуруктуру программы, а также увеличивают «эксцентриситет» текста при визуальном поиске. Структура программы теряется в случае, например, как на листинге выше, где метки аргументов и аргументы оказываются перепутанными, и чтобы найти определенный аргумент или метку, приходится прочитывать строку вместо того, чтобы просканировать область содержащую метки или имена значений аргументов. Такое расположение аргументов, однако, оказывается допустимым в случае короткой строки, когда весь список аргументов легко охватывается одним взглядом.

По ряду объективных факторов нам не удается полностью избежать длинных строк из-за использования длинных идентификаторов, которые мы не в силах изменить. Также в случаях, когда нас не интересует структура выражения (например, при выводе отладочного сообщения в лог программы), использование длинной строки может оказаться даже предпочтительнее, структурирования длинного выражения разбивкой его на несколько строк. Но в общем случае, длинная строка, как и длинный идентификатор, это признак плохо читаемого кода.
...
Как показали результаты исследований, использование любого другого разделителя между словами требует больших усилий при чтении. Пробелы также участвуют в формировании визуальной структуры, для разделения различных элементов синтаксической структуры программы. Поэтому, например, имеет смысл разделять пробелом имя функции и список ее параметров/аргументов, например, в случае, если их совокупная длина превышает размер области распознавания.
...
Открывающая фигурная скобка является часть блока кода, который она обрамляет на пару с закрывающей скобкой; и, поскольку мы ожидаем увидеть начала нового блока слева, то естественно и располагать открывающую скобку, как символ начала нового блока, слева, в начале новой строки.
