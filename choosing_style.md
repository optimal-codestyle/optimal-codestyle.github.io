...
5. Горизонтальная позиция открывающей скобки в стиле _Allman_ однозначно определят уровень вложенности, к которому она относится. В _1TBS_ эта информация отсутствует, так как расположение открывающей скобки в основном определяется лишь длиной строки, расположенной перед ней.
...
Переформатирование этого кода с использованием стилья _Allman_ позволяет получить более приемлимый результат.
...
Таким образом, выбор способа расстановки скобок должен осуществляться в каждом конкретном случае, следование «жестким» правилам расстановки рано или поздно приведет к неудовлетворительному результату. Более правильным будет использование комбинации стилей _Allman_ и _1TBS_, в которой первый является основным, а второй — дополнительным. 
