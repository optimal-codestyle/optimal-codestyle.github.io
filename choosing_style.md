...
<!--Естественно, возникает вопрос о том, насколько большим может быть смещение скобки вправо от начала строки, чтобы оно не вызывало заметных затруднений в восприятии программы. Говоря, о случаях, когда при этом расположении скобка не оказывается замаскированной большими массами кода непосредственно примыкающими к ней, можно предположить, что, во-первых, она должна находиться в левой части области кода, а во-вторых, смещение её от точки фиксации взгляда не должно  быть больше области распознавания (то есть 14-15 размеров букв).-->  

Таким образом, выбор способа расстановки скобок должен осуществляться в каждом конкретном случае, а формальное следование «жестким» правилам расстановки рано или поздно приведет к неудовлетворительному результату. Наиболее оптимальным вариантом видится комбинация стилей  _Allman_ (как основного) и _1TBS_ (как вспомогательного, используемого в редких случаях) . 
